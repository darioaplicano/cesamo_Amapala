...
<div class="row col-sm-9" id:="Elegir_Doctor">
   <div class="container">
  <form role="form">
      <div class="form-group col-sm-8" id="Selector2">
      <label for="sel1">Doctor que atendera la cita:</label>
...
<div class="row col-sm-9" id="formulario_nueva_cita">
  ...
  <div class="row form-group col-sm-5">
    ...
    <input type="text" maxlength="13"class="form-control" id="telefono" 
  ...
  <div class="form-group col-sm-9 row" id:="Elegir_Doctor">
      <div class="form-group col-sm-8" id="Selector2">
      <label for="sel1">Doctor que atendera la cita:</label>
      <select class="form-control" id="selectDoctor3">
          <option value=""></option>
      </select>
    </div>
</div>  
...
<div class="row" id="cancelarCita"> 
  ...
  <div class="form-group col-sm-9 row" id:="Elegir_Doctor">
      <div class="form-group col-sm-8" id="BotonMedico">
      <label for="sel1">Doctor que atendera la cita:</label>
      <select class="form-control" id="SeleccionarMedico">
          <option value=""></option>
      </select>
    </div>
</div>
